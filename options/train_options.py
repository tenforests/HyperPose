...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_type', default='yc_hypernet', type=str,
        ...
        self.parser.add_argument('--test_batch_size', default=12, type=int,
        ...
        self.parser.add_argument('--moco_lambda', default=0.1, type=float,
                                 help='Moco feature loss multiplier factor')

        # weights and checkpoint paths
        self.parser.add_argument('--stylegan_weights', default=model_paths["stylegan_human"], type=str,
        ...
        self.parser.add_argument('--val_interval', default=2000, type=int,
        ...
        self.parser.add_argument('--w_encoder_checkpoint_path', default=model_paths["e4e"], type=str,
                                 help='Path to pre-trained W-encoder.')
        self.parser.add_argument('--w_encoder_type', default='e4e',
                                 help='Encoder type for the encoder used to get the initial inversion')
        ...
        self.parser.add_argument("--hardcase", action='store_true', help='Whether to load a part data')
        self.parser.add_argument("--seq", action='store_true', help='video training method')
    def parse(self):
