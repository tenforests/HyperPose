...
# use cross and self attention in image encoder
class AttentionHyperNet(Module):
    def __init__(self, opts):
        super(AttentionHyperNet, self).__init__()

# use LIA optical enhancement
class OpticalEnhancementHyperNet(Module):
    def __init__(self, opts):
        super(OpticalEnhancementHyperNet, self).__init__()

# two hyperNet for face and body
class InsetHyperNet(Module):
    def __init__(self, opts):
        super(InsetHyperNet, self).__init__()

# collect all improvement
class FinalHyperNet(Module):
    def __init__(self, opts):
        super(FinalHyperNet, self).__init__()
# refine block and encoder
class SharedWeightsHyperNetResNet2(Module):
