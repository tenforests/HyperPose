# HyperPose method based on HyperStyle
...
--exp_dir=/home/zt/nas/experiments/hyperstyle_decoder_finetune \
--output_size=1024 \
--load_w_encoder \
--layers_to_tune=0,2,3,5,6,8,9,11,12,14,15,17,18,20,21,23,24 \
--train_decoder 
--checkpoint_path=/home/zt/nas/experiments/hyperstyle_full/checkpoints/iteration_100000.pt
```
```
CUDA_VISIBLE_DEVICES=3 python scripts/inference.py \
--exp_dir=/home/zt/nas/experiments/hyperstyle_full2 \
--checkpoint_path/home/zt/nas/experiments/hyperstyle_full2/checkpoints/iteration_100000.pt \
--load_w_encoder 
