...
DATASETS = {
	'ffhq_hypernet': {
 	...
 	'yc_hypernet': {
		'transforms': transforms_config.BodyEncodeTransforms,
		'train_source_root': dataset_paths['yc_target'],
		'train_target_root': dataset_paths['yc_target'],
		# 'train_ld_root': dataset_paths['yc_ld'],
		'test_source_root': dataset_paths['yc_target'],
		'test_target_root': dataset_paths['yc_target'],
  		# 'test_ld_root': dataset_paths['yc_ld'],
	},
